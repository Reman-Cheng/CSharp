	...
	for k,v in pairs(p2)do
        ...
        if escapeflag == false then			    
			    if p3.health <= 0 then
			    	print("➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣")
			    	print("--------==!!🎉🎉🎉🎊战斗胜利🎊🎉🎉🎉!!==--------")
			    	print("💰: +"..p3.gold.." 经验: +"..p3.experience.." 符文石:+"..p3.runestone.." 升级还需: "..p1.experience.."/"..p1.level*10)
			    	print("➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣➤➣➣➣➣")
			    end
			    if p1.health > 0 then
