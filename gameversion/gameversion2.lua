-- 创建对象====
person = {name = "💩",health = 100,level =1,experience = 0 ,emojo = "^_^",attack = 20,gold = 1000,speed = 10,armor = 10,power = 100,lifegold = 0}
...
p.addlife = function (self)
	if self.gold < 1000 then
		print("你的金币不足: "..self.gold.." 需要金币: 1000")
	else
