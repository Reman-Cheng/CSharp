-- 创建对象====
person = {name = "💩",health = 100,level =0,experience = 0 ,emojo = "^_^",attack = 30,gold = 1000,speed = 10,armor = 10,power = 100,lifegold = 0}
...
function status(self,p1)
    print("====你的❤️  "..p1.health.."/"..inithealth(self))
       ...
       if i == v[2] then
            if game[1] == "请选择要购买的物品" then
			    ...
			    if k ~= "quit" then
					...
					print(v[2]..": "..v[1].." 消耗: "..v[3].." 蓝量".." 功能: 直接秒杀怪物")
			        end
			    else
			    	print(v[2]..": "..v[1])
			    end
...
function move1(self,p1,game,article,adjust,shoppingflag)
	while dead == false do
      ...
      print("====⚰️you are died⚰️====你的等级: ",p.level)
	  print('=======游戏结束=======')
	  print('=======游戏退出=======')
	  os.exit()
end
...
function start(p,p,game,article,adjust)
	...
	if file1 == "" then
        ...
        if inputlife == "1" then  
		       ...
		       pcopy = {}
		       local i=0
				for v in string.gmatch(file1,"([_@#$%^&%w]+),")do
				    i=i+1
