...
function createmonster()
	 ...
	 Goblin = person:new()
	 Goblin = person.change(Goblin,"哥布林",40,5,20,"$_$",10,30,10,10,10,2)
	 Ganunu = person:new()
	 Ganunu = person.change(Ganunu,"加努努",60,10,50,"#_#",20,100,20,20,20,5)
	 Cthulhu = person:new()
	 Cthulhu = person.change(Cthulhu,"克苏鲁",80,15,100,"@_@",40,200,40,40,40,8)
	 Caikunxu = person:new()
	 Caikunxu = person.change(Caikunxu,"菜虚昆",100,30,300,"&_&",60,500,60,60,60,10)
end
-------------------------------------------------------------
    ...
    if p1.health >0 and p3.health>0 and escapeflag == false then
		for k,v in ipairs(pettable[2])do
			if p1.petname == v[1] then
				print("------"..p1.petname.." "..v[7].." 对 "..p3.name.." 发动攻击------")
